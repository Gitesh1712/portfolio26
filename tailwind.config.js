  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        cta: ['Plus Jakarta Sans', 'Manrope', 'sans-serif'],
      ...
      boxShadow: {
        'purple': '0 10px 28px rgba(0, 77, 155, 0.14)',
        'purple-lg': '0 18px 38px rgba(0, 77, 155, 0.18)',
        'purple-xl': '0 24px 54px rgba(0, 77, 155, 0.24)',
        'brand': '0 12px 32px rgba(0, 77, 155, 0.16)',
        'brand-lg': '0 20px 46px rgba(0, 77, 155, 0.2)',
      },
      backgroundImage: {
